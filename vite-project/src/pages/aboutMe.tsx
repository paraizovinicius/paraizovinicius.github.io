    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 mt-8 md:mt-0 ">
            ...
            <section className="max-w-3xl mx-auto py-12 px-6 space-y-6">
                ...
                <div id="academic-beginnings"></div>
                <div>
                ...
                <div id="corporate-experience"></div>
                <div>
                ...
                <div id="professional-trajectory"></div>
                <div>
                ...
                <div id="identity-researcher"></div>
                <div>
